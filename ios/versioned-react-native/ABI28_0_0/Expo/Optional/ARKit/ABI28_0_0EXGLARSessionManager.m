#import "ABI28_0_0EXGLARSessionManager.h"
#import <GPUImage.h>
...
ABI28_0_0RCT_ENUM_CONVERTER(ARWorldAlignment, (@{
...
@interface ABI28_0_0EXGLARSessionManager () <ARSessionObserver, ARSessionDelegate>
{
...
@property (nonatomic, weak) ABI28_0_0EXGLView *glView;
...
@implementation ABI28_0_0EXGLARSessionManager
  ...
  if (@available(iOS 11.0, *)) {
    if ([anchor isKindOfClass:[ARAnchor class]]) {
      ...
      NSDictionary *anchorData = @{
                                   @"type": type,
                                   @"transform": [ABI28_0_0EXGLARSessionManager nsArrayForMatrix:_anchor.transform],
...
+ (NSDictionary *)nsDictionaryForPlaneAnchor:(ARPlaneAnchor *)anchor
{
  ...
  return @{
           @"center": [ABI28_0_0EXGLARSessionManager nsDictionaryForVecFloat3:center],
           @"extent": @{
               @"width": @(extent[0]),
               @"length": @(extent[2])
               },
...
+ (NSDictionary *)nsDictionaryForImageAnchor:(ARImageAnchor *)anchor
{
  return @{
           @"image": @{
               ...
               @"size": [ABI28_0_0EXGLARSessionManager nsDictionaryForSize: anchor.referenceImage.physicalSize],
               },
           };
}
...
+ (NSArray *)nsArrayForAnchors:(NSArray *)anchors props:(NSDictionary *)props
{
  ...
  if (@available(iOS 11.0, *)) {
    for (ARAnchor *anchor in anchors) {
      NSDictionary *anchorData = [ABI28_0_0EXGLARSessionManager nsDictionaryForAnchor:anchor props:props];
...
- (NSDictionary *)startWithGLView:(ABI28_0_0EXGLView *)glView trackingConfiguration:(NSString *) trackingConfiguration
{
  ...
  if (!self.configuration) {
    return @{
             @"error": @"Invalid ABI28_0_0ARTrackingConfiguration, ARKit may not be available on this device.",
             };
  }
...
- (void)_maybeSetupCameraTextureWithWidth:(int)width height:(int)height
{
  ...
  if (err) {
    NSLog(@"ABI28_0_0EXGLARSessionManager: Error from CVOpenGLESTextureCacheCreate(...): %d", err);
  }
  _arCamYTex = NULL;
  _arCamCbCrTex = NULL;
  ...
  // Create camera texture output ABI28_0_0EXGLObject
...
- (NSDictionary *)arMatricesWithZNear:(CGFloat)zNear zFar:(CGFloat)zFar
{
  ...
  return @{
           @"transform": [ABI28_0_0EXGLARSessionManager nsArrayForMatrix:transform],
           @"viewMatrix": [ABI28_0_0EXGLARSessionManager nsArrayForMatrix:viewMat],
           @"projectionMatrix": [ABI28_0_0EXGLARSessionManager nsArrayForMatrix:projMat],
           };
}
  ...
  if (@available(iOS 11.0, *)) {
    ...
    for (ARHitTestResult *result in results) {
      [hitTest addObject:@{
                           ...
                           @"localTransform": [ABI28_0_0EXGLARSessionManager nsArrayForMatrix:result.localTransform],
                           @"worldTransform": [ABI28_0_0EXGLARSessionManager nsArrayForMatrix:result.worldTransform],
                           @"anchor": [ABI28_0_0EXGLARSessionManager nsDictionaryForAnchor:result.anchor props:@{}]
                           }];
    }
  }
  return @{
...
- (NSDictionary *)getCurrentFrameWithAttributes:(NSDictionary *)attributes
{
  ...
  if (@available(iOS 11.0, *)) {
    ...
    if (attributes[@"anchors"] != nil) {
      ...
      NSArray *anchors = [ABI28_0_0EXGLARSessionManager nsArrayForAnchors:self.session.currentFrame.anchors props:props];
                                               ...
                                               height:(int)height
{
  ...
  if (error != kCVReturnSuccess) {
    ...
    texture = nil;
    NSLog(@"ABI28_0_0EXGLARSessionManager: Error creating texture from pixel buffer. CVOpenGLESTextureCacheCreateTextureFromImage %d", error);
  }
...
- (void)_updateAnchors:(NSArray<ARAnchor *> *)anchors eventType:(NSString *)eventType
{
  NSDictionary *event = @{
                          @"eventType": eventType,
                          @"anchors": [ABI28_0_0EXGLARSessionManager nsArrayForAnchors:anchors props:@{}]
                          };
...
{
  [_delegate didUpdateWithEvent:@"DID_FAIL_WITH_ERROR" payload:ABI28_0_0RCTJSErrorFromNSError(error)];
}
...
- (void)session:(ARSession *)session cameraDidChangeTrackingState:(ARCamera *)camera
{
  NSArray *trackingStates = @[
                              @"ABI28_0_0ARTrackingStateNotAvailable",
                              @"ABI28_0_0ARTrackingStateLimited",
                              @"ABI28_0_0ARTrackingStateNormal"
                              ];
  NSArray *trackingStateReasons = @[
                                    @"ABI28_0_0ARTrackingStateReasonNone",
                                    @"ABI28_0_0ARTrackingStateReasonInitializing",
                                    @"ABI28_0_0ARTrackingStateReasonExcessiveMotion",
                                    @"ABI28_0_0ARTrackingStateReasonInsufficientFeatures",
                                    @"ABI28_0_0ARTrackingStateReasonRelocalizing"
                                    ];
